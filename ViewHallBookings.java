...
@WebServlet("/ViewHallBookings")
public class ViewHallBookings extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            String sql = "SELECT * FROM hall_booking";
            rs = stmt.executeQuery(sql);

            // HTML Table
            out.println("<html><head><title>Hall Bookings</title>");
            out.println("<style>");
            ...
            out.println("<h2> Hall Bookings</h2>");
            out.println("<table>");
            out.println("<tr><th>Booking ID</th><th>Event Name</th><th>Date</th><th>Time</th><th>Total Persons</th><th>Rent</th><th>Created At</th></tr>");

            while (rs.next()) {
                int bookingId = rs.getInt("hbooking_id");
