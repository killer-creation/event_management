...
public class ViewPayments extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            // HTML Table
            out.println("<html><head><title>Payments</title>");
            out.println("<style>");
            ...
            out.println("<table>");
            out.println("<tr><th>ID</th><th>Item Details</th><th>Mobile Number</th><th>Address Details</th><th>Payment Method</th><th>Created At</th></tr>");

            while (rs.next()) {
                int id = rs.getInt("id");
                String itemDetails = rs.getString("item_details");
                String mobileNumber = rs.getString("mobile_number");
                String addressDetails = rs.getString("address_details");
                ...
                out.println("<td>" + addressDetails + "</td>");
