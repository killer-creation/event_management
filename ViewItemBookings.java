...
@WebServlet("/ViewItemBookings")
public class ViewItemBookings extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            String sql = "SELECT * FROM event_item_booking";
            rs = stmt.executeQuery(sql);

            // HTML Table
            out.println("<html><head><title>Item Bookings</title>");
            out.println("<style>");
            ...
            out.println("<h2> Item Bookings</h2>");
            out.println("<table>");
            out.println("<tr><th>Booking ID</th><th>Machine Name</th><th>Quantity</th><th>Total Amount</th><th>Date/Time</th><th>Mobile No</th><th>Address</th></tr>");

            while (rs.next()) {
                int bookingId = rs.getInt("item_booking_id");
